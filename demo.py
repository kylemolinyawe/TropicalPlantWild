...
# # #---
# # # ROIs
# # preprocessing.extract_rois(val_paths, folder_filepath=val_demo_dir)
# # preprocessing.extract_rois(test_paths, folder_filepath=test_demo_dir)

# # # Building the ROI file path list
# # val_roi_paths = utils.get_file_paths(val_rois_dir)
# # test_roi_paths = utils.get_file_paths(test_rois_dir)

# # # Sorting the list wherein the index matches the file name
# # val_roi_paths = utils.reorder_list_by_filename(val_roi_paths)
# # test_roi_paths = utils.reorder_list_by_filename(test_roi_paths)

# # # Extracting feature vectors from ROIs
# # preprocessing.extract_roi_features(val_roi_paths, folder_filepath=val_demo_dir)
# # preprocessing.extract_roi_features(test_roi_paths, folder_filepath=test_demo_dir)

# val_roi_feature_paths = utils.get_file_paths(val_rois_features_dir)
# test_roi_feature_paths = utils.get_file_paths(test_rois_features_dir)

# evaluate.evaluate_visualbert('demo.pth', test_roi_feature_paths, labels, prompts_list, num_classes)